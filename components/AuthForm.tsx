            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="auth-form">
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <div className="shad-form-item">
                                        ...
                                        <FormControl>
                                            <Input placeholder="Enter you full name" className="shad-input" {...field} />
                                        </FormControl>
                                    </div>
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <div className="shad-form-item">
                                    ...
                                    <FormControl>
                                        <Input placeholder="Enter you email" className="shad-input" {...field} />
                                    </FormControl>
                                </div>
                                <FormMessage className="shad-form-message" />
                            </FormItem>
                    ...
                    <div className="body-2 flex justify-center">
                        <p className="text-light-100">{isSignIn ? "Don't have an account?" : "Already have an account?"}</p>
